...
public class SignUpCase : IRegisterUserUseCase
{
    ...
    public SignUpCase(IUserRepository userRepository, IPasswordHasher passwordHasher, SignUpValidator validator,
        IAccountNumberGenerator accountNumberGenerator, IAccountRepository accountRepository)
    {
    ...
    //
    //             var newUser = new User(signUpDto.Username, signUpDto.Email, signUpDto.PhoneNumber, passwordValueObject,
    //                 signUpDto.FirstName, signUpDto.LastName, signUpDto.Gender, signUpDto.DOB);
    //
    ...
    //
    //             // Create the account with default currency (assuming you have a default currency type)
    //             var defaultAccount =
    //                 new Account(newUser.Id, accountNumber, CurrencyType.NGN); // Adjust default currency as needed
    //
    //             await _accountRepository.AddAccountAsync(defaultAccount);
    //
